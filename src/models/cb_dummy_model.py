...
from .cb_recommend_models import DummyModel
...
def main(filename):
    """Trains a CB dummy model and saves it to the specified
    file.
    ...
    logger.info('Training CB dummy model...')
    dummy_model = train_dummy_model()

    logger.info(f'Saving CB dummy model to {filename}...')
