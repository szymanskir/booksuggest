...
The ``app`` folder contains a web application written in `Dash <https://plot.ly/products/dash/>`_ framework which allow users to explore the dataset and to provide a interactive way to experience of how the implemented recommendation models work.